      ...
      <div className="relative z-10 min-h-screen px-4 sm:px-6 md:px-8 py-8 sm:py-12 flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-start gap-8 sm:gap-12 max-w-[1400px] mx-auto">
          ...
          <div className="flex-1 w-full max-w-[600px] mx-auto lg:mx-0">
            <div className="vizag-content bg-[rgba(82,37,102,0.3)] border-2 border-dashed border-white/50 rounded-lg backdrop-blur-[10px]" style={{ padding: '48px', height: '400px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            ...
            {/* Contacts */}
            <div className="vizag-content mt-4 sm:mt-6 text-white text-center" style={{ fontFamily: 'BackToSchool, sans-serif !important' }}>
          ...
          {/* Hosting Partner */}
          <div className="vizag-content flex flex-col items-center justify-center gap-4 mx-auto lg:mx-0 lg:flex-shrink-0" style={{ height: '400px' }}>
            ...
            <div className="w-[160px] h-[160px] sm:w-[180px] sm:h-[180px] rounded-full bg-white/90 flex items-center justify-center p-4 shadow-[0_5px_20px_rgba(0,0,0,0.3)]">
              <img src="/vizag1.avif" alt="Hosting Partner" className="w-full h-full object-contain" />
            </div>
        ...
        {/* Note */}
        <div className="vizag-content max-w-[1200px] mx-auto mt-12 sm:mt-16 text-center text-white/90 text-sm sm:text-base lg:text-lg leading-relaxed px-4 sm:px-8">
        ...
        {/* Register Button */}
        <button 
          className="vizag-content block mx-auto mt-16 sm:mt-20 min-h-[56px] px-16 sm:px-20 lg:px-24 py-5 sm:py-6 rounded-[50px] font-semibold text-sm sm:text-base cursor-pointer transition-all duration-300 border-none uppercase active:scale-95"
          style={{
