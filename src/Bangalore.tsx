      ...
      <div className="relative z-10 min-h-screen px-4 sm:px-6 md:px-8 py-8 sm:py-12 flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-start gap-8 sm:gap-12 max-w-[1400px] mx-auto">
          ...
          <div className="flex-1 w-full max-w-[600px] mx-auto lg:mx-0">
            <div className="bangalore-content bg-[rgba(82,37,102,0.3)] border-2 border-dashed border-white/50 rounded-lg backdrop-blur-[10px]" style={{ padding: '48px', height: '400px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          ...
          {/* Hosting Partner */}
          <div className="bangalore-content flex flex-col items-center justify-center gap-4 mx-auto lg:mx-0 lg:flex-shrink-0" style={{ height: '400px' }}>
