...
Do you want to proceed with registration?`;
  ...
  return (
    <div className={`dashboard-container w-screen overflow-x-hidden relative font-sans min-h-screen ${timeTheme}-theme`}
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center lg:justify-start lg:pt-32 xl:pt-48 z-10 text-white text-center overflow-hidden" style={{background: "transparent"}} >
        {/* National Level Youth Festival Text - Positioned absolutely */}
        <div className="absolute top-16 sm:top-20 left-0 right-0 z-20 w-full px-4 sm:px-6 pt-4 sm:pt-8">
          <h2 className="text-white text-xs sm:text-sm md:text-base lg:text-lg font-semibold" style={{
            fontFamily: 'serif',
        ...
        <div className="flex justify-center items-center z-20 relative w-full px-2 sm:px-4 -mt-12 sm:-mt-16 md:-mt-20" style={{display: "flex", justifyContent: "center"}}>
          <img src={`${import.meta.env.BASE_URL}image.avif`} alt="Vignan Mahotsav" className="w-11/12 sm:w-10/12 md:w-9/12 lg:w-8/12 xl:w-7/12 max-w-4xl object-contain bg-transparent border-none shadow-none animate-fadeInDown" style={{height: "auto", maxWidth: "none"}} />
        </div>
        <style>{`
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 lg:gap-8 mt-8 sm:mt-12 md:mt-16 lg:mt-20 mb-4 justify-center items-center z-20 relative px-4 w-full">
          {isLoggedIn ? (
            <button className="w-40 h-11 sm:w-44 sm:h-12 md:w-48 md:h-13 lg:w-52 lg:h-14 xl:w-60 xl:h-14 bg-gradient-to-r from-[#FF69B4] to-[#FF1493] text-white rounded-2xl text-sm sm:text-base md:text-lg lg:text-xl font-semibold cursor-pointer transition-all duration-300 border-4 border-transparent hover:border-[#FFD700] hover:-translate-y-1 hover:shadow-lg flex items-center justify-center touch-manipulation active:scale-95" onClick={() => {
              // Open modal immediately
      ...
      >
        <div className="about-theme-container" style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 20px', position: 'relative' }}>
          {/* Garuda Logo - Above title on mobile only */}
          ...
          {/* Garuda Logo - Desktop only (side position) */}
          ...
          <div ref={statsRef} style={{
            ...
            <div className="grid grid-cols-2 lg:grid-cols-6 gap-6 lg:gap-8" style={{
              maxWidth: '1536px',
              margin: '0 auto'
            }}>
              {/* Footfall */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 py-8 sm:py-10 md:py-12 relative z-10">
          ...
          <div className="flex flex-col items-center lg:items-start order-1 lg:order-1">
            <img 
              ...
              alt="Mahotsav 2026" 
              className="h-28 sm:h-32 md:h-36 lg:h-20 object-contain mb-4 sm:mb-5 md:mb-6"
            />
            {/* Social Media Icons */}
            <h3 className="text-white text-sm sm:text-base font-bold mb-3 sm:mb-4 tracking-wide">FOLLOW US ON :</h3>
            <div className="flex gap-3 sm:gap-4 mb-4 justify-center lg:justify-start">
              <a href="https://www.instagram.com/vignan_mahotsav/profilecard/?igsh=dDE1MHNpcmM4eXhm" target="_blank" rel="noopener noreferrer" className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 rounded-full bg-white/10 flex items-center justify-center transition-all duration-300 hover:bg-white/20 hover:scale-110 active:scale-95 touch-manipulation">
                <svg className="w-5 h-5 sm:w-5 sm:h-5 md:w-6 md:h-6" viewBox="0 0 24 24" fill="#fff">
              ...
              <a href="https://whatsapp.com/channel/0029Vars0ZXJ3jutqK5hfj3r" target="_blank" rel="noopener noreferrer" className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 rounded-full bg-white/10 flex items-center justify-center transition-all duration-300 hover:bg-white/20 hover:scale-110 active:scale-95 touch-manipulation">
                <svg className="w-5 h-5 sm:w-5 sm:h-5 md:w-6 md:h-6" viewBox="0 0 24 24" fill="#fff">
              ...
              <a href="https://linkedin.com/company/vignan-mahotsav" target="_blank" rel="noopener noreferrer" className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 rounded-full bg-white/10 flex items-center justify-center transition-all duration-300 hover:bg-white/20 hover:scale-110 active:scale-95 touch-manipulation">
                <svg className="w-5 h-5 sm:w-5 sm:h-5 md:w-6 md:h-6" viewBox="0 0 24 24" fill="#fff">
          ...
          {/* Contact Us Section */}
          <div className="flex flex-col items-center lg:items-start order-2 lg:order-2">
            <h3 className="text-white text-sm sm:text-base font-bold mb-3 sm:mb-4 tracking-wide">CONTACT US :</h3>
            <div className="flex flex-col gap-3 sm:gap-4 items-center lg:items-start w-full">
              <a href="mailto:mahotsav@vignan.ac.in" className="flex items-center gap-3 text-white hover:text-yellow-400 transition-colors touch-manipulation justify-center lg:justify-start">
                ...
                <span className="text-xs sm:text-sm md:text-base break-all">mahotsav@vignan.ac.in</span>
              </a>
              <a href="tel:+919493033592" className="flex items-center gap-3 text-white hover:text-yellow-400 transition-colors touch-manipulation justify-center lg:justify-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
                </svg>
                <span className="text-xs sm:text-sm md:text-base">+91 94930 33592</span>
              </a>
              <a href="tel:+919030557363" className="flex items-center gap-3 text-white hover:text-yellow-400 transition-colors touch-manipulation justify-center lg:justify-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
                </svg>
                <span className="text-xs sm:text-sm md:text-base">+91 90305 57363</span>
              </a>
            </div>
          </div>

          {/* Location Section */}
          <div className="flex flex-col items-center lg:items-start order-3 lg:order-3">
            <h3 className="text-white text-sm sm:text-base font-bold mb-3 sm:mb-4 tracking-wide">LOCATION :</h3>
            <div className="flex items-start gap-3 mb-4 justify-center lg:justify-start text-center lg:text-left">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 mt-1 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2">
                <path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/>
                <circle cx="12" cy="10" r="3"/>
              </svg>
              <p className="text-white text-xs sm:text-sm md:text-base leading-relaxed m-0">
            ...
            <a 
              ...
              className="text-purple-400 hover:text-purple-300 text-xs sm:text-sm md:text-base inline-flex items-center gap-2 transition-colors touch-manipulation active:scale-95 mx-auto lg:mx-0"
            >
              VIEW ON GOOGLE MAPS
