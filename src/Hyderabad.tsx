      ...
      <div className="relative z-10 min-h-screen px-4 sm:px-6 md:px-8 py-8 sm:py-12 flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-start gap-8 sm:gap-12 max-w-[1400px] mx-auto">
          ...
          <div className="flex-1 w-full max-w-[600px] mx-auto lg:mx-0">
            <div className="hyderabad-content bg-[rgba(82,37,102,0.3)] border-2 border-dashed border-white/50 rounded-lg backdrop-blur-[10px] p-6 sm:p-8 md:p-10 lg:p-14" style={{ height: '400px', width: '700px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              ...
              <div className="flex flex-col gap-6 sm:gap-8 md:flex-row md:gap-12 text-white" style={{ fontFamily: 'BackToSchool, sans-serif !important' }}>
                ...
                <div className="flex flex-col gap-3 sm:gap-4 min-w-[120px] sm:min-w-[150px]">
                  ...
                  <div className="flex flex-col py-3 sm:py-4 border-b border-white/30">
                    ...
                    <div className="text-sm sm:text-base md:text-lg" style={{ fontFamily: 'BackToSchool, sans-serif !important', marginLeft: '30px' }}>(7+3)</div>

                  </div>
                  <div className="flex flex-col py-3">
                    <div className="font-bold text-base sm:text-lg md:text-xl mb-1" style={{ fontFamily: 'BackToSchool, sans-serif !important', marginLeft: '30px' }}>Football</div>
            ...
            {/* Contacts */}
            <div className="hyderabad-content mt-3 sm:mt-4 md:mt-6 text-white text-center pt-4 sm:pt-5" style={{ fontFamily: 'BackToSchool, sans-serif !important',marginTop: '20px'}}>
        ...
        {/* Note */}
        <div className="hyderabad-content max-w-[1200px] mx-auto mt-0 text-center text-white/90 text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed px-4 sm:px-8 py-4 sm:py-5" style={{ fontFamily: 'arial, sans-serif',marginTop: '20px',marginBottom: '20px'   }}>
